...
// use setInterval function to display current date and time
...
// USe JSON.parse to get data from local storage as a js object and return value using .val()method
function initPage() {
...
// changing color on textarea follow the current time. 
function background () {
